    ...
    <div class="w3-container"><br>
        ...
        <div class="w3-container w3-display-middle" id="boxCekDiagnosis" style="width: 30%; margin-top: 4%;">
            <center style="font-family: font2;"">
                ...
                <hr>
                <label class="container" style="font-family: font2; text-align: left;" >Balita menderita diare 
                        <input type="checkbox" name="checkbox">
                        <span class="checkmark"></span> 
                </label>
                <label class="container" style="font-family: font2; font-size: 20px; text-align: left;">Darah di dalam tinja
                    <input type="checkbox" name="checkbox">
                    <span class="checkmark"></span>
                </label><br>
                <label for="diare" style="font-family: font2; font-size: 20px; text-align: left;">Berapa lama (hari) :</label>
