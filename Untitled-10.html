...
<head>
    <title>Pemeriksaan 7 - Diagnosis Sederhana</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="w3-container"><br>
        ...
        <!-- isi data pasien -->
        <div class="w3-container w3-display-middle" id="boxCekDiagnosis" style="width: 30%; margin-top: 5%;">
            <center style="font-family: font2;">
                <h1 style = " text-align: center;">Memeriksa Status Gizi</h1>
                <hr>
                <label class="container" style="font-family: font2; text-align: left; font-size: 15px; ">Balita tampak sangat kurus
                    <input type="checkbox" name="checkbox">
                    <span class="checkmark"></span>
                </label>
                <label class="container" style="font-family: font2;  text-align: left; font-size: 15px;">Ada pembengkakkan di kedua punggung kaki
                    <input type="checkbox" name="checkbox">
                    <span class="checkmark"></span>
                </label>
                <label class="container" style="font-family: font2;text-align: left; font-size: 15px;">
                Tentukkan berat badan (BB) menurut panjang badan (PB) atau tinggi badan (TB) sesuai dengan umur dan jenis kelamin <br>
                - BB/PB (TB) < - 3 SD <br>
                - BB/PB (TB) - 3 SD sampai - 2 SD <br>
                - BB/PB (TB) >= - 2 SD <br>
                </label> 
                <label for="batuk" style="font-family: font2; text-align: left; font-size: 15px;">BB/PB (TB):</label>
                <input type="text" placeholder="BB/PB (TB)" name="kali"> <br>
                <label for="batuk" style="font-family: font2; text-align: left; font-size: 15px;">LILA:</label>
                <input type="text" placeholder="LILA" name="kali"> <br>
