    ...
    <div class="w3-container"><br>
        ...
        <div class="w3-container w3-display-middle" id="boxCekDiagnosis" style="width: 30%; margin-top: 4%;">
            <center style="font-family: font2;">
                ...
                <input type="date" placeholder="Tanggal Lahir" name="tl" required> <br>
				<input type="text" placeholder="No. Handphone" name="notelp" required> <br>
                
                <button type="submit" name="simpan" class="btn btn-primary w3-theme-d4">Daftar </button>
				</form>
            </center>
        </div>
