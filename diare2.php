...
<head>
    <title>Pemeriksaan 2 - Diagnosis Sederhana</title>
    <meta charset="utf-8">
    ...
    <div class="w3-container"><br>
        ...
        <div class="w3-container w3-display-middle" id="boxCekDiagnosis" style="width: 30%; margin-top: 4%;">
            <center style="font-family: font2;"">
                <h1 style = "text-align: center;">Memeriksa Diare</h1>
                <h2 style = "text-align: center;">(2/2)</h2>
                <hr>
                <label class="container" style="font-family: font2; text-align: left;" >Letargis atau tidak sadar
                        <input type="checkbox" name="checkbox">
                        <span class="checkmark"></span> 
                </label>
                <label class="container" style="font-family: font2; font-size: 20px; text-align: left;">Malas minum
                    <input type="checkbox" name="checkbox">
                    <span class="checkmark"></span>
                </label>
                <label class="container" style="font-family: font2; text-align: left;" >Rewel atau mudah marah
                        <input type="checkbox" name="checkbox">
                        <span class="checkmark"></span> 
                </label>
                <label class="container" style="font-family: font2; font-size: 20px; text-align: left;">Minum dengan lahap
                    <input type="checkbox" name="checkbox">
                    <span class="checkmark"></span>
                </label><br>   
